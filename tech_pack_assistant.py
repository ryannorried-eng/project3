...
Provides a small CLI and reusable model helpers for creating a technical-design
tech pack with:
- style metadata
...
def _build_parser() -> Any:
    ...
    export = sub.add_parser("export-md", help="Export markdown tech pack")
    export.add_argument("--file", default="tech_pack.json", help="Existing tech pack JSON path")
    export.add_argument("--out", default="tech_pack.md", help="Output markdown path")
